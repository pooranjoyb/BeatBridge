...
export default function Home() {
  ...
  return (
    <>
        ...
        {menuOpen && (
        <div className="fixed inset-0 bg-gray-800 opacity-70 z-50" onClick={closeMenu}></div>
      )}
      <div className={`fixed top-0 right-0 h-full w-64 bg-white shadow-lg transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform ease-in-out duration-300 z-50`}>
        <div className="flex justify-end p-2">
          <button className="text-gray-500 hover:text-gray-700" onClick={closeMenu}>
        ...
        <ul className="p-4 font-serif text-xl mb-4">
          <li className="py-2 pl-4 hover:bg-gray-200 cursor-pointer flex items-center">
            <FaHome className="mr-2" />Discover</li>
          <li className="py-2 pl-4 hover:bg-gray-200 cursor-pointer flex items-center"><GrGallery className='mr-2'/>Around You</li>
          <li className="py-2 pl-4 hover:bg-gray-200 cursor-pointer flex items-center"><BsFillPeopleFill className="mr-2" />Top Artists</li>
          <li className="py-2 pl-4 hover:bg-gray-200 cursor-pointer flex items-center"> <FaHashtag className="mr-2" />Top Charts</li>
        </ul>
      </div>
        <FeaturesHomePage />
    </>
