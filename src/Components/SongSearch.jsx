                    ...
                    <section className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-10">
                        {
                            tracks.map((elem, index) => {
                                return (
                                    <div key={elem.album.id} className="bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 shadow-lg rounded p-3 w-2/3 m-10">
                                        ...
                                        <div className="p-5">
                                            <h3 className="text-[#9a3412] font-bold text-lg">{elem.album.name}</h3>
                                            <p className="text-[#5f2917]">{elem.artists[0].name}</p>
                                        </div>
                                    </div>
                                )
                            })
